...
public class OtherSpotlightView extends View {
	...
	public interface AnimationSetupCallback {
		void onSetupAnimation(OtherSpotlightView spotlight);
	}

	public OtherSpotlightView(Context context, AttributeSet attrs) {
		super(context, attrs);
    ...
    Timber.d("###################onAttachedToWindow###################");
        ...
        Timber.d("###################onGlobalLayout###################");
				...
				if (mCallback != null) {
					mCallback.onSetupAnimation(OtherSpotlightView.this);
				}
